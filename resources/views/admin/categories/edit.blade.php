        ...
        <div class="card">
          ...
          <div class="card-body">
           <form action="/categories/update/{{ $categories->id }}" method="post">
            ...
            @method('put')
            <div class="mb-3">
                <label for="nama_product" class="form-label">Nama Kategori</label>
                <input type="text" class="form-control" id="name" name="name" value="{{ $categories->name }}" placeholder="nama product">
             </div>
