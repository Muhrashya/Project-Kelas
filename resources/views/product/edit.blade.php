          ...
          <div class="card-body">
           <form action="/product/update/{{ $product->id }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nama_product" name="nama_product" value="{{ $product->nama_product }}" placeholder="nama product">
             </div>
            <div class="mb-3">
                <label for="label" class="form-label">Jenis Product</label>
                <input type="text" class="form-control" id="jenis_product" name="jenis_product" value="{{ $product->jenis_product }}" placeholder="jenis product">
             </div>
            <div class="mb-3">
                <label for="label" class="form-label">Harga</label>
                <input type="number" class="form-control" id="harga" name="harga" value="{{ $product->harga }}" placeholder="harga">
             </div>
            <div class="mb-3">
                <label for="label" class="form-label">Stok</label>
                <input type="number" class="form-control" id="stok" name="stok" value="{{ $product->stok }}" placeholder="harga">
             </div>
            <div class="mb-3">
                <label for="label" class="form-label">ID Supllier</label>
                <input type="number" class="form-control" id="idsuplier" name="idsuplier" value="{{ $product->idsuplier }}" placeholder="harga">
             </div>
            <div class="mb-3">
