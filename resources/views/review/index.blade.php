            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="pull-right" style="text-align: right"><button class="btn btn-success">
                        <a href="/create/review" style="color: white"> Add Data </a>
                       </button>
                    </h3>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <table class="table table-sm table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $no++ }}</td>
                                    <td>{{ $rv->feedbackUser }}</td>
                                    <td>{{ $rv->komentar }}</td>
                                    <td>{{ $rv->ranting }}</td>
                                    <td>
                                        <form action="/review/delete/{{ $rv->id }}" method="POST">
                                            @csrf
                                            {{-- @method('delete') --}}
                                            <button type="button" class="btn btn-primary btn-xs"><i class="fa fas-pencil">
                                              <a href="/review/edit/{{ $rv->id }}" style="color: white">Update</a> </i></button>
