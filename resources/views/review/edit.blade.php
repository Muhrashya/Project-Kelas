        ...
        <div class="card">
          ...
          <div class="card-body">
           <form action="/review/update/{{ $review->id }}" method="POST">
            ...
            @method('put')
            <div class="mb-3">
                <label for="nama_product" class="form-label">feedbackUser</label>
                <input type="text" class="form-control" id="feedbackUser" name="feedbackUser" value="{{ $review->feedbackUser }}" placeholder="nama product">
             </div>
            <div class="mb-3">
                <label for="label" class="form-label">Jenis Product</label>
                <input type="text" class="form-control" id="komentar" name="komentar" value="{{ $review->komentar }}" placeholder="jenis product">
             </div>
            <div class="mb-3">
                <label for="label" class="form-label">Harga</label>
                <input type="number" class="form-control" id="ranting" name="ranting" value="{{ $review->ranting }}" placeholder="harga">
             </div>
