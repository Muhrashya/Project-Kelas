          ...
          <div class="card-body">
           <form action="/shop/store" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="berat_produk" name="berat_produk" placeholder="berat produk">
             </div>
            <div class="mb-3">
                <label for="label" class="form-label">Deskripsi produk</label>
                <input type="text" class="form-control" id="deskripsi_produk" name="deskripsi_produk" placeholder="harga">
             </div>
             <div class="mb-3">
                <label for="nama_product" class="form-label">Ranting</label>
                <input type="text" class="form-control" id="ranting" name="ranting" placeholder="ranting">
             </div>
            <div class="mb-3">
